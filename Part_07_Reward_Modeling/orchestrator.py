...
#
# Run from inside `Part_07_Reward_Modeling/`:
#   cd Part_07_Reward_Modeling
...
if __name__ == "__main__":
    ...
    if args.demo:
        run("python train_rm.py --steps 300 --batch_size 8 --block_size 256 --n_layer 2 --n_head 2 --n_embd 128 --loss bt --bpe_dir ../Part_04_Scaling_Up/runs/scalingup-demo/tokenizer")
        run("python eval_rm.py --ckpt runs/rm-demo/model_last.pt --split train[:8] --bpe_dir ../Part_04_Scaling_Up/runs/scalingup-demo/tokenizer")
        run("python eval_rm.py --ckpt runs/rm-demo/model_last.pt --split test[:8] --bpe_dir ../Part_04_Scaling_Up/runs/scalingup-demo/tokenizer")

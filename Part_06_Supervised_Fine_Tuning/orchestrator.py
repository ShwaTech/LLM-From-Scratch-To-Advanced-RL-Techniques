...
#
#   Part_06_Supervised_Fine_Tuning/
...
#       test_masking.py
#
# Run from inside `Part_06_Supervised_Fine_Tuning/`:
#   cd Part_06_Supervised_Fine_Tuning
...
if __name__ == "__main__":
    ...
    # 2) optional demo
    if args.demo:
        # --ckpt ../Part_04_Scaling_Up/runs/scalingup-demo/model_last.pt # assumes Part 4 demo has been run
        run("python train_sft.py --data huggingface --ckpt ../Part_04_Scaling_Up/runs/scalingup-demo/model_last.pt --out runs/sft-demo --steps 300 --batch_size 8 --block_size 256 --n_layer 2 --n_head 2 --n_embd 128")

...
from policy import PolicyWithoutValue
...
def score_policy(policy_ckpt: str, rm_ckpt: str, bpe_dir: str | None, n: int = 16):
    ...
    ckpt_ref = torch.load("../Part_06_Supervised_Fine_Tuning/runs/sft-demo/model_last.pt", map_location=device) # hardcoded path to SFT checkpoint
